...
const QuizControl: FC<Props> = ({ questionGenerator, onStart }) => {
	...
	return (
		<div className="flex flex-row flex-nowrap gap-x-5 items-center !text-3xl">
			...
			<button
				className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 font-bold !text-3xl"
